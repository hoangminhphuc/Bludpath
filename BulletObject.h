#ifndef BULLETOBJECT _H
#define BULLETOBJECT _H

#include "AllFunc.h"
#include "Spine.h"

class BulletObject : public Spine
{
    public:
        BulletObject();
        ~BulletObject();
    ...
    private:
        int x_val_;
        int y_val_;
        bool is_move_;// lợi dụng biến này để xem có di chuyển hay không, nếu false thì xóa nó đi
        unsigned int bullet_dir_;
        unsigned int bullet_type_;

};

#endif // BULLETOBJECT _H
